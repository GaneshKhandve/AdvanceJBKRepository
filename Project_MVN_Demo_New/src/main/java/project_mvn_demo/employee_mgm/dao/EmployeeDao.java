package project_mvn_demo.employee_mgm.dao;

import project_mvn_demo.employee_mgm.dbconnection.EmployeeDBConnection;
...
public class EmployeeDao {
    ...
    public List<Employee> getAllEmployeeDetails() {
        ...
        try {
            con = EmployeeDBConnection.getEmpDbConnection();
